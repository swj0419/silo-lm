...
class Options():
    ...
    def add_knn_options(self):
        ...
        self.parser.add_argument("--no_fuzzy_verbalizer", action='store_true', help="disable fv for knn")
        self.parser.add_argument("--lm_fuzzy_verbalizer", action='store_true', help="use fv for lm")
